(function($) {
  ...
  window.renderCaptcha = function(form_selector) { // function we can call to render the captcha as needed
    var recaptchaElement = document.querySelector(form_selector+' .g-recaptcha');
