...
namespace Drupal\contacter_norgen\Form;
...
class ContacterNorgenForm extends FormBase
{

  public function getFormId()
  {
    return 'contacter_norgen_form';
  }

  public function buildForm(array $form, FormStateInterface $form_state)
  {

    $form['#prefix'] = '<div id = "contacternorgenform-container" div class="contacternorgenform-container">';
    ...
    $form['contacter_company'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Entreprise/Institution'),
      '#required' => TRUE,
    ];

    $form['contacter_job'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Titre d\'emploi'),
      '#required' => TRUE,
    ];
  ...
  public function submitCallback(array &$form, FormStateInterface $form_state)
  {
    ...
    $Selector = '#contacternorgenform-container';
  ...
  public function submitForm(array &$form, FormStateInterface $form_state)
  {
    ...
    $date = date("Ymd");
    $form_name = $this->t('Contact Us French');
    ...
    $output = '<p>Hello,</p>
    <p>A customer submitted their request for Contact us French Form.</p>
    ...
    if ($form_state->hasAnyErrors()) {
      ...
      $subject = '[Contact form] - Contact Us French ' . date("F j, Y, g:i a", $time);
