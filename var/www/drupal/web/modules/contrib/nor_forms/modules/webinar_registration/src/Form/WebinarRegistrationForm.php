...
class WebinarRegistrationForm extends FormBase
{
        ...
        case 2:
          ...
          $form[$step]['other_information']['referral']['referral_select'] = [
            ...
            '#options' => array(
              ...
              'Local Distributor' => $this->t('Local Distributor'),
              'Other' => $this->t('Other'),
            ),
            '#ajax' => [
  ...
  public function changePage(array &$form, FormStateInterface $form_state){
    ...
    $webinar_link = 'https://youtube.com/live/s0E5VxT8ShI'; // 9:30am
  ...
  public function submitForm(array &$form, FormStateInterface $form_state){
    ...
    if($form_state->getTriggeringElement()['#value']=='Next') $form_state->set('sample_current_step_id', $form_state->get('sample_current_step_id') + 1);
      ...
      if ($form_state->hasAnyErrors()) {} 
        ...
        $recipient_email = 'emarketing@NorgenBiotek.com,info@norgenbiotek.com'; // real addresses
        //$recipient_email = 'liam.howes@norgenbiotek.com';
        $customer_email = $email;
        $subject_org = ' [Webinar Registration] ' . $first_name . ' (' . $email . ')- ' . date('F j, Y, g:i a', $time) ." ".$insert_id;
        $subject_customer = 'Thank You '.$first_name.' for Registering!';
