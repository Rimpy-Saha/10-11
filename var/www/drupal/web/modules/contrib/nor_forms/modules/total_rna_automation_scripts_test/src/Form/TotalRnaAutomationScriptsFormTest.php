...
namespace Drupal\total_rna_automation_scripts_test\Form;
...
class TotalRnaAutomationScriptsFormTest extends FormBase
{

  public function getFormId()
  {
    return 'total_rna_automation_scripts_test';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state)
  {
    ...
    $form['rna_sample_type_fieldset']['rna_sample_type'] = [
      '#type' => 'checkboxes',
      '#title' => $this->t('What Sample Types Do You Work With? (check all that apply)'),
      '#options' => array_combine($rna_sample_options, $rna_sample_options),
      '#ajax' => [
    ...
    if ($form_state->getValue('rna_sample_type') !== null && in_array('Other', $form_state->getValue('rna_sample_type'))) {
      // Get the text of the selected option.
      $form['rna_sample_type_fieldset']['rna_sample_type_specify_other'] = [
        '#type' => 'textfield',
  ...
  public function validateForm(array &$form, FormStateInterface $form_state){
    ...
    if (empty($form_state->getValue('rna_sample_type'))) {
      $form_state->setErrorByName('rna_sample_type', $this->t('Please select your sample types.'));
    }
  ...
  {
    return $form['rna_sample_type_fieldset'];
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state)
  {
    ...
    $rna_sample_type_specified_other = $form_state->getValue('rna_sample_type_specify_other');
    if($form_state->getValue('rna_sample_type_specify_other') !== null){
      $form_state->getValue('rna_sample_type')['Other'] = $rna_sample_type_specified_other; // replace "Other" value with the specified text value from the textfield
    }
    $rna_sample_type = implode(",", array_filter($form_state->getValue('rna_sample_type')));
    ...
    $query->values([$date, $first_name, $last_name, $email, $rna_sample_type, '', time(), $form_name, $subscribe, $country_name]);
    $query->execute();
    ...
    <p>Last name: ' . $last_name . '<br>First name: ' . $first_name . '<br>Email: ' . $email . '<br>Sample Type: ' . $rna_sample_type . '<br>Country: ' . $country_name . ' <br>Mailing List: ' . $subscribe_mail;
