...
namespace Drupal\contact_japan\Form;
...
class ContactJapanForm extends FormBase
{

  public function getFormId()
  {
    return 'contact_japan_form';
  }

  public function buildForm(array $form, FormStateInterface $form_state)
  {

    $form['#prefix'] = '<div id = "contactjapanform-container" div class="contactjapanform-container">';

    $form['contacter_fname'] = [
      '#type' => 'textfield',
      '#title' => $this->t('ファーストネーム'),
      '#required' => TRUE,
    ];
  ...
  public function submitCallback(array &$form, FormStateInterface $form_state)
  {
    ...
    $Selector = '#contactjapanform-container';
  ...
  public function submitForm(array &$form, FormStateInterface $form_state)
  {
    ...
    $date = date("Ymd");
    $form_name = $this->t('Contact Us Japan');
    ...
    $output = '<p>Hello,</p>
    <p>A customer submitted their request for Contact us Japan Form.</p>
    ...
    if ($form_state->hasAnyErrors()) {
      ...
      $subject = '[Contact form] - Contact Us Japan ' . date("F j, Y, g:i a", $time);
