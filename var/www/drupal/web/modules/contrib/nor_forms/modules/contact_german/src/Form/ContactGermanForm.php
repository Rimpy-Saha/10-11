...
namespace Drupal\contact_german\Form;
...
class ContactGermanForm extends FormBase
{

  public function getFormId()
  {
    return 'contact_german_form';
  }

  public function buildForm(array $form, FormStateInterface $form_state)
  {

    $form['#prefix'] = '<div id = "contactgermanform-container" div class="contactgermanform-container">';

    $form['contacter_fname'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Nombre de pila'),
      '#required' => TRUE,
    ];
    ...
    $form['contacter_company'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Empresa/Institución'),
      '#required' => TRUE,
    ];

    $form['contacter_job'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Título profesional'),
      '#required' => TRUE,
    ];
    ...
    $form['actions']['submit'] = [
      '#type' => 'submit',
      '#value' => $this->t('Senden Sie Ihre E-Mail'),
      '#button_type' => 'primary',
      '#submit' => ['::submitForm'],
      '#ajax' => [
  ...
  public function submitCallback(array &$form, FormStateInterface $form_state)
  {
    ...
    $Selector = '#contactgermanform-container';
  ...
  public function submitForm(array &$form, FormStateInterface $form_state)
  {
    ...
    $date = date("Ymd");
    $form_name = $this->t('Contact Us German');
    ...
    $query->fields(['created_on', 'first_name', 'last_name', 'email', 'record', 'timestamp', 'form_name', 'phone', 'company']); //wrong syntax here breaks entire submit function 
    $query->values([$date, $first_name, $last_name, $email, '', time(), $form_name, $phone, $company]);
    $query->execute();
    ...
    $output = '<p>Hello,</p>
    <p>A customer submitted their request for Contact us German Form.</p>
    ...
    if ($form_state->hasAnyErrors()) {
      ...
      $subject = '[Contact form] - Contact Us German ' . date("F j, Y, g:i a", $time);
