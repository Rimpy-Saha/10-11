...
namespace Drupal\contact_spanish\Form;
...
class ContactSpanishForm extends FormBase
{

  public function getFormId()
  {
    return 'contact_spanish_form';
  }

  public function buildForm(array $form, FormStateInterface $form_state)
  {

    $form['#prefix'] = '<div id = "contactspanishform-container" div class="contactspanishform-container">';
    ...
    $form['actions']['submit'] = [
      '#type' => 'submit',
      '#value' => $this->t('Envía tu correo electrónico'),
      '#button_type' => 'primary',
      '#submit' => ['::submitForm'],
      '#ajax' => [
  ...
  public function submitCallback(array &$form, FormStateInterface $form_state)
  {
    ...
    $Selector = '#contactspanishform-container';
  ...
  public function submitForm(array &$form, FormStateInterface $form_state)
  {
    ...
    $date = date("Ymd");
    $form_name = $this->t('Contact Us Spanish');
    ...
    $output = '<p>Hello,</p>
    <p>A customer submitted their request for Contact us Spanish Form.</p>
    ...
    if ($form_state->hasAnyErrors()) {
      ...
      $subject = '[Contact form] - Contact Us Spanish ' . date("F j, Y, g:i a", $time);
