<?php
namespace Drupal\commerce_norshipping\Service;
  /**
...
include '/var/www/drupal/web/modules/contrib/commerce_norshipping/lib/commerce_norshipping_package_types.inc';
include '/var/www/drupal/web/modules/contrib/commerce_norshipping/lib/commerce_norshipping_package_information.inc';
include '/var/www/drupal/web/modules/contrib/commerce_norshipping/lib/commerce_norshipping_zone_rates.inc';
include '/var/www/drupal/web/modules/contrib/commerce_norshipping/lib/commerce_norshipping_zone_types.inc';
include '/var/www/drupal/web/modules/contrib/commerce_norshipping/lib/commerce_norshipping_zone_information.inc';



class CommerceNorShippingMain {
    ...
    function commerce_norshipping_build_rates_main($shipment)
    {
        ...
        */
        ...
        include  '/var/www/drupal/web/modules/contrib/commerce_norshipping/lib/commerce_norshipping_build_rates_calculate_packing.inc';
        ...
        */
        ...
        include  '/var/www/drupal/web/modules/contrib/commerce_norshipping/lib/commerce_norshipping_build_rates_calculate_rates.inc';
