 ...
 */
 ...
 setTimeout(function () {
  if (typeof gtag === 'function' && 
      ...
      typeof Drupal.eu_cookie_compliance.getCurrentStatus === 'function') {
    
    var consentStatus = Drupal.eu_cookie_compliance.getCurrentStatus();

    if (consentStatus === '1' || consentStatus === '2') {
      gtag('consent', 'update', { // Google Tag Manager
        'ad_storage': 'granted',
      ...
      if (typeof window.clarity === 'function') {
        window.clarity('consent'); // Microsoft Clarity
      }
      // console.log("Consent granted for ad_storage and analytics_storage.");
    } else {
      ...
      // console.log("Default consent settings applied (denied).");
    }

    gtag('consent', 'get', function (consentDetails) {
      console.log('Current consent settings:', consentDetails);
    });
  }
}, 1000);
...
(function ($, Drupal, drupalSettings, cookies) {
  ...
  ? drupalSettings.eu_cookie_compliance.cookie_value_disagreed 
  : '0';
  var cookieValueAgreedShowThankYou, cookieValueAgreed;
...
if (typeof drupalSettings.eu_cookie_compliance !== 'undefined') {
  ...
  cookieValueAgreedShowThankYou = '1';
  cookieValueAgreed = '2';
}
  ...
  Drupal.eu_cookie_compliance.execute = function () {
    try {
      ...
      if (typeof drupalSettings.eu_cookie_compliance !== 'undefined' &&
    typeof drupalSettings.eu_cookie_compliance.cookie_name !== 'undefined' &&
  ...
  Drupal.eu_cookie_compliance.getBannerBottomHiddenPosition = function () {
  	console.log("getBannerBottomHiddenPosition -GOT")
  ...
  Drupal.eu_cookie_compliance.createPopup = function (html, closed) {
    ...
    if (drupalSettings.eu_cookie_compliance.popup_position) {
      ...
      if (closed !== true) {
        popup.show();
        popup.css({top: Drupal.eu_cookie_compliance.getBannerTopPosition(height)});
  ...
  Drupal.eu_cookie_compliance.declineAction = function () {
    ...
    gtag('consent', 'update', { // gtag default
      'ad_storage': 'denied',
      'ad_user_data': 'denied',
      'ad_personalization': 'denied',
      'analytics_storage': 'denied'
