  ...
  Drupal.behaviors.js_styles = {
    attach: function (context, settings) {
      $('.c-content-isotope-overlay-content .flag, .c-content-isotope-overlay-content .commerce-add-to-cart button', context)
        .removeAttr('class')
        .attr('class', 'c-content-isotope-overlay-btn btn c-btn-white c-btn-uppercase c-btn-bold c-btn-border-1x');

      $('.node-product-teaser .c-content-product-2 .form-submit', context)
        .removeAttr('class')
        .attr('class', 'btn btn-lg c-btn-white c-btn-uppercase c-font-grey-3 c-font-white-hover c-bg-red-2-hover c-btn-product');

      $('.node-product-teaser-list .c-content-product-2 .form-submit', context)
        .removeAttr('class')
        .attr('class', 'btn btn-sm c-theme-btn c-btn-uppercase c-btn-bold');

      $('.node-product-teaser-list .flag-compare a, .node-product-teaser-list .flag-wishlist a', context)
        .addClass('flag btn btn-sm btn-default c-btn-uppercase c-btn-bold');
    }
  };
